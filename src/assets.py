...
sprite_paths = {
  ...
  "icon_fire": "assets/icon-fire.png",
  "icon_ice": "assets/icon-ice.png",
  "icon_volt": "assets/icon-volt.png",
  "icon_wind": "assets/icon-wind.png",
  "icon_skull": "assets/icon-skull.png",
  "icon_heartplus": "assets/icon-heartplus.png",
