...
input.config( # TODO: this isn't ideal - do we need to extend a generic wrapper app to make this more reusable?
  buttons={
    ...
    input.BUTTON_A: [gamepad.A, pygame.K_f],
    input.BUTTON_B: [gamepad.B, pygame.K_g],
    input.BUTTON_X: [gamepad.X, pygame.K_r],
    input.BUTTON_Y: [gamepad.Y, pygame.K_t],
    input.BUTTON_L: [gamepad.L, pygame.K_TAB],
